...
import namkeen_snacks_image from "./Savory.png"
import laddu_mithai_image from "./Sweets.png"
import farsan_image from "./Farsan.png"
import fried_delicacies_image from "./Fried.png"
import dry_fruits_image from "./DryFruits.png"
import indian_cookies_image from "./Cookies.png"
import festive_image from "./Seasonal.png"
...
export const categories = [
  {
    text: "Savory & Namkeen",
    path: "Savory",
    // Assumes you have an image for general snacks/namkeen
    image: namkeen_snacks_image, 
    bgColor: "#FEF6DA", // Light Yellow/Tan
  },
  {
    text: "Mithai & Laddoo",
    path: "Sweets",
    // Assumes you have an image for laddoos/traditional sweets
    image: laddu_mithai_image, 
    bgColor: "#FEE0E0", // Light Pink/Red
  },
  {
    text: "Farsan & Fafda",
    path: "Farsan",
    // Assumes you have an image for fafda/ghathiya/dhokla-like items
    image: farsan_image, 
    bgColor: "#F0F5DE", // Pale Green/Olive
  },
  {
    text: "Deep Fried Snacks",
    path: "Fried",
    // Assumes you have an image for jalebi/nimki/thekua/bhakarwadi
    image: fried_delicacies_image, 
    bgColor: "#E1F5EC", // Light Cyan/Aqua
  },
  {
    text: "Dry Fruits & Nuts",
    path: "DryFruits",
    // Assumes you have an image for almonds, cashews, etc.
    image: dry_fruits_image, 
    bgColor: "#FEE6CD", // Light Orange/Peach
  },
  {
    text: "Cookies & Biscuits",
    path: "Cookies",
    // Assumes you have an image for shakarpara/nankhatai/Indian cookies
    image: indian_cookies_image, 
    bgColor: "#E0F6FE", // Pale Blue
  },
  {
    text: "Festive Specials",
    path: "Seasonal",
    // Assumes you have an image for seasonal/festival-specific items
    image: festive_image, 
    bgColor: "#F1E3F9", // Light Purple/Mauve
  },
];
...
export const features = [
  {
    ...
    description: "Your favorite snacks delivered fresh to your door.",
  },
  {
    icon: leaf_icon,
    title: "Freshness Guaranteed",
    description: "Made fresh daily with the finest, pure ingredients.",
  },
  {
    icon: coin_icon,
  ...
  },
  {
    ...
    description: "Each snack is prepared with care and perfection.",
  },
];
