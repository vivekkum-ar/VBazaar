    ...
    return (
        ...
        <div className="md:p-10 p-4 space-y-4">
            ...
            {orders.map((order, index) => (
                <div key={index} className="flex flex-col md:flex md:flex-row justify-between  md:items-center gap-5 p-5 max-w-4xl rounded-md border border-gray-300 ">
                    ...
                    <div className="text-sm md:text-base text-black/60">
                        ...
                        <p className="">{order.address.street}, {order.address.city},</p>
