...
const BottomBanner = () => {
    return (
        <div className='relative mt-24'>
            <img src={assets.bottom_banner_image} alt="Banner" className='w-full hidden md:block' srcset="" />
            <img src={assets.bottom_banner_image_sm} alt="Banner" className='w-full md:hidden' srcset="" />
