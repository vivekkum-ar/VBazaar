...
const Cart = () => {
    const { products,user, currency,axios,setCartItems, cartItems, removeFromCart, getCartCount, updateCartItem, navigate, getCartAmount } = useAppContext();
  ...
  try {
    // The authentication cookie/header handles identifying the user.
